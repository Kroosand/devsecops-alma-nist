...
"""
==============================================================================
Benchmark Comparativo de Tiempo Medio de Resolución (MTTR)
...
def simulate_incidents(num_samples=30):
    print("=" * 80)
    print("  SIMULACIÓN ESTADÍSTICA DE MTTR: SITUACIÓN ACTUAL VS PROPUESTA MEJORADA")
    print("=" * 80)
    ...
    print(f" -> Reducción porcentual del tiempo de respuesta: {reduction_pct:.2f}%")
