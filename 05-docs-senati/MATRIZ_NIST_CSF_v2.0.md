...
| **DETECTAR (DE)** | **DE.AE-01 / DE.CM-01** | Monitorización continua y captura de anomalías de seguridad y eventos de escaneo. | **SOP-04** | `04-soar-n8n-testing/trigger_alert.py`<br>`04-soar-n8n-testing/metrics_logger.py` |
| **RESPONDER (RS)** | **RS.AN-01 / RS.MI-01** | Triage automatizado SOAR con n8n, despacho de alertas críticas a Telegram en $< 15$ min. | **SOP-04** | `04-soar-n8n-testing/generate_mttr_report.py`<br>Flujos n8n de Waldir Chullo |
| **RESPONDER (RS)** | **RS.AN-01** | Triage inteligente asistido por IA (Claude) para clasificación contextual y remediación dinámica. | **SOP-07** | `04-soar-n8n-testing/ai_triage.py`<br>`05-docs-senati/SOP-07_TRIAGE_IA.md` |
